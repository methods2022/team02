...
function ncbi_mesh_search(pubmed_query, header, api_key)
    ...
    while (global_retstart <= retmax)
        ...
        output_file_name = "temporal_single/antiviral.txt"
...
function main()
    ...
    ncbi_mesh_search(pubmed_query, header, "407521d452cc948463ab38e791772aff9008")
end
